                    ...
                    {classes.map((cls) => (
                        ...
                        >
                            ...
                            <div className="mt-4 flex items-center text-amber-600 text-sm font-bold">
                                Ver Tabla de Clase <ChevronRight className="w-4 h-4 ml-1" />
                            </div>
                        </div>
                    ))}
                </div>
                        ...
                        <div className="bg-slate-950 p-6 border-b border-slate-800 flex justify-between items-start shrink-0">
                            <div>
                                ...
                                <div className="flex gap-4 text-sm text-slate-400">
                                    <span className="flex items-center gap-1"><Shield className="w-4 h-4" /> Dado de Golpe: d{selectedClass.hitDie}</span>
                                    <span className="flex items-center gap-1"><Zap className="w-4 h-4" /> Principal: {selectedClass.primaryAbility.join(", ")}</span>
                                </div>
                            </div>
                                    ...
                                    <table className="w-full text-left text-sm text-slate-300">
                                        <thead className="bg-slate-900 text-xs uppercase font-bold text-amber-500 border-b border-slate-800">
                                            <tr>
                                                ...
                                                <th className="px-4 py-3 min-w-[200px]">Rasgos de Clase</th>
                                                {/* Columnas Dinámicas (Furia, Ataque Furtivo, Espacios, etc) */}
                            ...
                            {selectedClass.subclasses && selectedClass.subclasses.length > 0 && (
                                <div>
                                    <div className="flex items-center gap-3 mb-6 border-b border-slate-800 pb-4">
                                        ...
                                        <h3 className="text-3xl font-bold text-slate-100 font-serif">
